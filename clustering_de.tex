...
\maketitle
  ...
  Wahrscheinlichkeit für eine Verbindung zwischen je zwei Objekten im 
  ...
  Anzahl an Verknüpfungen hat, und die meisten weniger stark verknüpft sind. Weiterhin
  ist die Gradverteilung auch lokal sehr inhomogen, so dass sich Teilgraphen ausbilden,
  deren Knoten untereinander sehr stark bis komplett verknüpft sind.
  Diese Teilgraphen werden auch 'Cluster' genannt.
  
  Für viele Anwendungsgebiete sind diese Cluster von verstärktem Interesse, da stark
  verknüpfte Knoten oftmals die gleichen Eigenschaften besitzen.
    
  in human relation networks offenbaren gruppen in vielen formen wie etwa
  freundeskreise, arbeitskollegen, staedt etc zeigen konnen. 
  ...
  of these communities within a network. A prime example in the context of 
  social network sites is the suggestion of possible friends or the identification 
  of common interests, which is crucial for any kind of social marketing. 
  
  But clustering analysis in graphs is not limited to human social networks. In
  the authors outlined various real world networks, in which the detection of
  clusters within the graphs is essential. 
 
 This paper provides an o
