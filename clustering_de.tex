...
\section{Grundlagen}
  ...
  \subsubsection{k-Cliques}
  	...
  	miteinander verbunden sind, und $\Omega$ somit komplett ist. Die entstehende Topologie des
  	...
  	Beispiel mit 2 und 3 Knoten
  	
  	man nennt k cliquen benachbart, falls zwei k cliquen k-1 Knoten teilen
